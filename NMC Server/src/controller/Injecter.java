...
public class Injecter {
	...
	public void injector(AlbumCollector album){
		db.openConnection();
		String query1 = "INSERT INTO nmc_additions values (DEFAULT, NOW(), '"+Profil.getInstance().getId()+"');";
		String query2 = "INSERT INTO nmc_media values (DEFAULT, '"+album.getTitle()+"', '"+album.getRelPath()+"', 'album', (SELECT id FROM nmc_permissions WHERE level = '"+album.getVisibilityID()+"'), (SELECT id FROM nmc_permissions WHERE level = '"+album.getModificiationID()+"'), (SELECT id FROM nmc_additions ORDER BY id DESC LIMIT 1));";
		String query3;
	...
	public void injector(BookCollector book){
		db.openConnection();
		String query1 = "INSERT INTO nmc_additions values (DEFAULT, NOW(), '"+Profil.getInstance().getId()+"');";
		String query2 = "INSERT INTO nmc_media values (DEFAULT, '"+book.getTitle()+"', '"+book.getRelPath()+"', 'book', (SELECT id FROM nmc_permissions WHERE level = '"+book.getVisibilityID()+"'), (SELECT id FROM nmc_permissions WHERE level = '"+book.getModificiationID()+"'), (SELECT id FROM nmc_additions ORDER BY id DESC LIMIT 1));";
		String query3;
	...
	public void injector(ImageCollector image){
		db.openConnection();
		String query1 = "INSERT INTO nmc_additions values (DEFAULT, NOW(), '"+Profil.getInstance().getId()+"');";
		String query2 = "INSERT INTO nmc_media values (DEFAULT, '"+image.getTitle()+"', '"+image.getRelPath()+"', 'image', (SELECT id FROM nmc_permissions WHERE level = '"+image.getVisibilityID()+"'), (SELECT id FROM nmc_permissions WHERE level = '"+image.getModificiationID()+"'), (SELECT id FROM nmc_additions ORDER BY id DESC LIMIT 1));";
	...
	public void injector(VideoCollector video){
		db.openConnection();
		String query1 = "INSERT INTO nmc_additions VALUES (DEFAULT, NOW(), '"+Profil.getInstance().getId()+"');";
		String query2 = "INSERT INTO nmc_media VALUES (DEFAULT, '"+video.getTitle()+"', '"+video.getRelPath()+"', 'video', (SELECT id FROM nmc_permissions WHERE level = '"+video.getVisibilityID()+"'), (SELECT id FROM nmc_permissions WHERE level = '"+video.getModificiationID()+"'), (SELECT id FROM nmc_additions ORDER BY id DESC LIMIT 1));";
		String query3;
		...
		String query5 = "INSERT INTO nmc_media_info_films VALUES ((SELECT id FROM nmc_media ORDER BY id DESC LIMIT 1), (SELECT id FROM nmc_videos ORDER BY id DESC LIMIT 1));";
	...
	public void injector(SeriesCollector series){
		db.openConnection();
		String query1 = "INSERT INTO nmc_additions VALUES (DEFAULT, NOW(), '"+Profil.getInstance().getId()+"');";
		String query2 = "INSERT INTO nmc_media VALUES (DEFAULT, '"+series.getTitle()+"', '"+series.getRelPath()+"', 'series', (SELECT id FROM nmc_permissions WHERE level = '"+series.getVisibilityID()+"'), (SELECT id FROM nmc_permissions WHERE level = '"+series.getModificiationID()+"'), (SELECT id FROM nmc_additions ORDER BY id DESC LIMIT 1));";
		String query3;
	...
	public void injector(EpisodeCollector episode){
		...
		if (episode.getSeason() == null && episode.getChrono() == null)
			query4 = "INSERT INTO nmc_media_info_series(nmc_media_info_id, nmc_episodes_id, title, nmc_addition_id) VALUES ((SELECT id FROM nmc_videos ORDER BY id DESC LIMIT 1), (SELECT id FROM nmc_media WHERE title = '"+episode.getSeries()+"' AND type = 'series'), '"+episode.getTitle()+"', (SELECT id FROM nmc_additions ORDER BY id DESC LIMIT 1));";
		else if (episode.getSeason() == null)
			query4 = "INSERT INTO nmc_media_info_series(nmc_media_info_id, nmc_episodes_id, title, chrono, nmc_addition_id) VALUES ((SELECT id FROM nmc_videos ORDER BY id DESC LIMIT 1), (SELECT id FROM nmc_media WHERE title = '"+episode.getSeries()+"' AND type = 'series'), '"+episode.getTitle()+"', '"+episode.getChrono()+"', (SELECT id FROM nmc_additions ORDER BY id DESC LIMIT 1));";
		else if(episode.getChrono() == null)
			query4 = "INSERT INTO nmc_media_info_series(nmc_media_info_id, nmc_episodes_id, title, season, nmc_addition_id) VALUES ((SELECT id FROM nmc_videos ORDER BY id DESC LIMIT 1), (SELECT id FROM nmc_media WHERE title = '"+episode.getSeries()+"' AND type = 'series'), '"+episode.getTitle()+"', '"+episode.getSeason()+"', (SELECT id FROM nmc_additions ORDER BY id DESC LIMIT 1));";
		else
			query4 = "INSERT INTO nmc_media_info_series(nmc_media_info_id, nmc_episodes_id, title, season, chrono, nmc_addition_id) VALUES ((SELECT id FROM nmc_videos ORDER BY id DESC LIMIT 1), (SELECT id FROM nmc_media WHERE title = '"+episode.getSeries()+"' AND type = 'series'), '"+episode.getTitle()+"', '"+episode.getSeason()+"', '"+episode.getChrono()+"', (SELECT id FROM nmc_additions ORDER BY id DESC LIMIT 1));";
		String query5 = null;
		String query6 = null;
